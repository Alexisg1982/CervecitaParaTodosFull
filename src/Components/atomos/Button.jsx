...
const ButtonComponent = ({
    ...
    const StyledButton = styled(Button)({
        ...
        '&:hover': {
            ...
            backgroundColor: backgroundColor === 'black' ? '#000000': getColor(color),
            color: Default.white,
            borderColor: getColor(color),
        },
        ...sx,
    ...
    return (
        <StyledButton variant={variant} size={size} color={color} borderColor={borderColor} hoverOutlined={hoverOutlined} rounded={rounded}>
            {title}
        </StyledButton>
    );
};
